...
class ExperimentSpec:
    ...
    source_experiment_id: str | None = None  # For tracking variations
...
class ExperimentSelector:
    ...
    def __init__(self, config: VariationConfig | None = None):
        ...
        self._generation_stats: dict[str, int | float] = defaultdict(int)
...
def create_experiment_selector(config: VariationConfig | None = None) -> ExperimentSelector:
