...
class TestMetricsEndpoint:
    ...
    def test_initialization(self):
        ...
        endpoint = MetricsEndpoint(
            host=self.host, port=self.port, max_connections=5, request_timeout=15.0
        )
    ...
    def test_initialization_with_exporter(self):
        ...
        endpoint = MetricsEndpoint(host=self.host, port=self.port, metrics_exporter=exporter)
...
class TestMetricsEndpointHTTP:
    ...
    def test_http_metrics_endpoint_with_exporter(self):
        ...
        exporter = PrometheusMetricsExporter()
        self.endpoint = MetricsEndpoint(host=self.host, port=self.port, metrics_exporter=exporter)
    ...
    def test_gzip_compression(self):
        ...
        with self.endpoint:
            ...
            response = requests.get(
                f"{self.base_url}/metrics", headers={"Accept-Encoding": "gzip"}, timeout=5
            )
    ...
    def test_performance_characteristics(self):
        ...
        ), f"Average response time {avg_response_time:.2f}ms exceeds 100ms SLA"
    ...
    def test_server_stats_tracking(self):
        ...
        with self.endpoint:
            ...
            for _endpoint_name, endpoint_data in endpoint_stats.items():
