...
class TestPrometheusMetricsExporter:
    ...
    def test_metrics_export(self):
        ...
        assert 'claude_process_startup_seconds' in metrics_output or 'claude_process_memory_usage_mb' in metrics_output
    ...
    def test_performance_characteristics(self):
        ...
        assert export_duration < 10.0, f"Export took {export_duration:.2f}ms, exceeds 10ms requirement"
    ...
    def test_integration_with_existing_components(self):
        ...
        metric_names = [line.split('{')[0].split(' ')[0] for line in metric_lines if line and not line.startswith('#')]
        ...
        for prefix in expected_prefixes:
            has_prefix = any(name.startswith(prefix) for name in metric_names)
...
class TestPrometheusMetricsExporterEdgeCases:
    ...
    def test_memory_usage_characteristics(self):
        ...
        assert memory_overhead < 20.0, f"Memory overhead {memory_overhead:.2f}MB exceeds reasonable limit"
