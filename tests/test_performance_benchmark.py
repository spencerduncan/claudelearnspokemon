...
class TestPerformanceBenchmarks:
    ...
    async def test_batch_vs_sequential_performance(self) -> None:
        ...
        with patch.object(self.client, "_make_async_request") as mock_request:
            ...
            print(
                f"Latency reduction: {((sequential_time - batch_time) / sequential_time) * 100:.1f}%"
            )
            ...
            assert (
                actual_time_per_input < target_time_per_input
    ...
    async def test_realistic_pokemon_gameplay_scenarios(self) -> None:
        ...
        with patch.object(self.client, "_make_async_request") as mock_request:
            ...
            for scenario, metrics in performance_results.items():
                ...
                print(
                    f"{scenario:20s}: {metrics['total_time']:.3f}s "
    ...
    async def test_scalability_with_large_batches(self) -> None:
        ...
        with patch.object(self.client, "_make_async_request") as mock_request:
            ...
            for batch_size in batch_sizes:
                ...
                assert (
                    time_per_input < 0.010
                ), f"Time per input {time_per_input:.4f}s > 0.010s limit"
            ...
            for result in scalability_results:
                print(
                    f"{result['batch_size']:>10d} {result['total_time']:>10.3f}s "
